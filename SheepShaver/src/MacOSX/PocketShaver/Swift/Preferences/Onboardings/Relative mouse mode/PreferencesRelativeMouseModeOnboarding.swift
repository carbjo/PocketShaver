...
By the <img/> button, located on top of the software keyboard. The software keyboard is accessed by swiping up with three fingers.
This is the only way to access this button, even if using bluetooth mouse as input on an iPad.
